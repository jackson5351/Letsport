...
<section class="text-center my-5">
  ...
  <!-- Section heading -->
  <h2 class="h1-responsive font-weight-bold text-center my-5">Shoes</h2>
  ...
  <div class="row" style="margin: 1%">
    ...
    <?php
    $result = mysqli_query($dtbs, "SELECT * FROM product where category='shoes'");
        while ($row = mysqli_fetch_array($result))
        {
          ...
          <img src='image/".$row['product_image']."' class='card-img-top'
            alt='sample photo'>
          <a>
        ...
        echo "<h4 class='card-title'>
          ...
          echo "<span class='float-left font-weight-bold'>
             ...
             echo "<input type='number' name='quantity' value='1' min='1' max=$stock class='form-control' >";
