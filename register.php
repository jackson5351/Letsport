...
<form class="text-center border border-light p-5" style="width: 40% ;height: 72%; margin:0 auto;margin-bottom: 57px; "  method="post" action="register.php">
    ...
    <div class="form-row mb-4">
        <div class="col">
            <!-- First name -->
            <input type="text" id="defaultRegisterFormFirstName" class="form-control" placeholder="First name"  value="<?php echo $firstName; ?>" name="firstName">
        </div>
        <div class="col">
            <!-- Last name -->
            <input type="text" id="defaultRegisterFormLastName" class="form-control" placeholder="Last name" value="<?php echo $lastName; ?>" name="lastName">
        </div>
    </div>

    <!-- E-mail -->
    <input type="email" id="defaultRegisterFormEmail" class="form-control mb-4" placeholder="E-mail" value="<?php echo $email; ?>" name="email">
